...
{
    public const string itemPath = "Assets/Create/Shader/HLSLTemplate";
    [MenuItem(itemPath, false, 80)]
    public static void CreatNewLua()
    {
        ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0,
            ScriptableObject.CreateInstance<MyDoCreateScriptAsset>(),
            GetSelectedPathOrFallback() + "/HlslUnlit.shader",
            null,
            "Assets/Template/HlslUnlit.shader");
    }
